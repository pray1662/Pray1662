...
function aboutView() {
  return `<section class="info-page">
    ...
    <div class="about-sections">
      ...
      <section><h2>Texts and permissions</h2><p>Pray1662 is rooted in the worship and theology of the 1662 Book of Common Prayer. Alongside the original language of the Prayer Book, we also use contemporary-language material from <em>An English Prayer Book</em> (Church Society, 1994), with the kind permission of Church Society.</p><p>We are grateful to Church Society for allowing this material to be used in Pray1662. You can find out more about their work and access further Prayer Book resources at <a href="https://www.churchsociety.org/" target="_blank" rel="noopener noreferrer">Church Society</a>.</p></section>
